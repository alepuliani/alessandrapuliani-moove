...
const bici1 = new Mezzo("bici", 672265, "disponibile");
const bici2 = new Mezzo("bici", 647821, "disponibile");
const scooter1 = new Mezzo("scooter", 490210, "disponibile");
const monopattino1 = new Mezzo("monopattino", 925543, "disponibile");
const monopattino2 = new Mezzo("monopattino", 997433, "disponibile");
const monopattino3 = new Mezzo("monopattino", 947937, "disponibile");
/* These lines of code are creating instances of the `Citta` class, which represents a city with
available transportation options. */
const Roma = new Citta("Roma", [scooter1]);
const Milano = new Citta("Milano", [bici1, monopattino2]);
/* The code snippet you provided is creating instances of the `Utente` class, which represents users in
the system. */
const utente1 = new Utente("Francesco", "Rossi", "francescorossi@gmail.com", "bancomat");
const utente2 = new Utente("Giulia", "Bianchi", "giuliabianchi@hotmail.it", "paypal");
